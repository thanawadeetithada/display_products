...
<head>
    ...
    <style>
    /* ปรับสไตล์เล็กน้อยให้คล้ายของเดิม */
    .navbar-brand {
        font-weight: 700;
        letter-spacing: .5px;
    }

    /* ถ้าต้องการให้ลิงก์ตัวหนาชัดขึ้น */
    .navbar-nav .nav-link {
        font-weight: 500;
    }
    ...
    /* กัน footer ชิดขอบมือถือเกินไป (ถ้ายังไม่มีใน style2.css) */
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-light border-bottom sticky-top">
        <div class="container">
            <!-- โลโก้/ชื่อแบรนด์ -->
            <a class="navbar-brand" href="index2.php">LUMA AIR</a>
                ...
                <div class="col-12 col-sm-6 col-lg-2 fcol">
                    ...
                    <ul class="f-list">
                        <li>
                            ...
                            <span>02-123-4567<br>089-123-4567</span>
                        </li>
                        <li>
                            <span class="ficon" aria-hidden="true">
                                <svg viewBox="0 0 24 24">
                ...
                <div class="col-12 col-sm-6 col-lg-3 fcol">
                    ...
                    <ul class="f-list">
                        <li>
                            ...
                            <span>123 ถนนสุขุมวิท แขวงคลองเคย<br>เขตคลองเคย กรุงเทพมหานคร 10110</span>
                        </li>
                    </ul>
                </div>
